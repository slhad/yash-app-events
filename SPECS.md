...
SPEC-UI-003 | IN_PROGRESS | native GUI live preview/freeze/metrics and reconnect recovery pass with screenshot/RPC evidence in `docs/gui-acceptance-report.md`; GUI-triggered portal selection currently terminates on a Hyprland Wayland `invalid object` error, and cancel/deny acceptance remains (2026-07-11)
